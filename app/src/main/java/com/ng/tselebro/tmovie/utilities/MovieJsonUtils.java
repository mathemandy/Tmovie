...
import com.ng.tselebro.tmovie.Models.ReviewItem;
...
//            get the id of the movie
            long movieId = singlePoster.getInt(MOVIE_ID);
...
//           Get the user Rating
            double user_rating = singlePoster.getInt(USER_RATING);
...
//            get the url siting the address of the review
